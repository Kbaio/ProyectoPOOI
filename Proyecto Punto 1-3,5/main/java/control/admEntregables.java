...
public class admEntregables {
    ...
    public String registrarEntregables(int id, boolean estado, String descripcion, 
            ...
            , ArrayList<Casillero> listaCasilleros, int idCliente, ArrayList<Cliente> listaClientes){
    ...
    public String cobroArticulosRetirados(String nombreCliente, float descuento){
        float monto = 0;
        float montoTotal = 0;
        float montoPeso = 0;
        ...
        System.out.println(listaEntregables);
        for(int i = 0; i < listaEntregables.size(); i++){
            System.out.println(monto);
            Entregable eActual = listaEntregables.get(i);
            if(eActual.getEstado() == true && eActual.getRemitente().equalsIgnoreCase(nombreCliente)){
