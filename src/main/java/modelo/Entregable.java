...
public class Entregable {
    ...
    public Entregable(int id, String descripcion, String remitente, String registro, Sobre sobre) {
        this.id = id;
    ...
    public Entregable(int id, String descripcion, String remitente, String registro, Paquete paquete) {
        this.id = id;
        this.descripcion = descripcion;
        this.remitente = remitente;
        this.registro = new Date(registro);
    ...
    public Entregable(int id, String descripcion, String remitente, String registro, Revista revista) {
        this.id = id;
        this.descripcion = descripcion;
        this.remitente = remitente;
        this.registro = new Date(registro);
